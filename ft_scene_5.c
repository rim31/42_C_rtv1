...
/*   Updated: 2016/04/22 14:32:02 by oseng            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "rtv1.h"

static void	ft_scene_5c(t_env *a)
{
	a->obj[5].name = "cylindre";
	a->obj[5].color.x = 0x0F;
	a->obj[5].color.y = 0xFE;
	a->obj[5].color.z = 0x00;
	a->obj[5].center.x = -20.0;
	a->obj[5].center.y = 0;
	a->obj[5].center.z = 0;
...
static void	ft_scene_5b(t_env *a)
{
	a->obj[3].name = "cone";
...
static void	ft_scene_5a(t_env *a)
{
	a->obj[1].name = "sphere";
	a->obj[1].color.x = 255;
